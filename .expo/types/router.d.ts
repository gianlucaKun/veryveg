...
export namespace ExpoRouter {
  type StaticRoutes = `/..\components\Scanner` | `/..\components\forms\AddProductForm` | `/..\components\forms\ProductForm` | `/..\components\forms\formAddProduct` | `/..\services\ProductAPI` | `/_sitemap` | `/details` | `/hiddenDatails` | `/home` | `/scansiona`;
